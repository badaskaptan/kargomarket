...
const EditModalTransportService: React.FC<EditModalTransportServiceProps> = ({
  listing,
  isOpen,
  onClose,
  onSave
  ...
  const getTransportIcon = () => {
    ...
    const IconComponent = icons[formData.serviceTransportMode as keyof typeof icons];
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[95vh] overflow-y-auto border border-gray-200">
        {/* Header */}
        <div className="bg-gradient-to-r from-purple-600 to-indigo-700 px-8 py-6 rounded-t-2xl relative overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Nakliye İlanını Düzenle</h2>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8 bg-gradient-to-b from-gray-50 to-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-6 py-4 border border-gray-300 rounded-full focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors shadow-sm"
                required
            ...
            {formData.serviceTransportMode && (
              <div>
                ...
                >
                  ...
                  {vehicleTypes[formData.serviceTransportMode as keyof typeof vehicleTypes]?.map((group, groupIndex) => (
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-6 py-4 border border-gray-300 rounded-full focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors shadow-sm"
                    placeholder="Örn: 180m x 28m x 10m"
                  />
                </div>
                ...
                <div>
                  ...
                  >
                    <option value="">Seçiniz</option>
                    <option value="lumpsum">Lump Sum (Götürü)</option>
                    <option value="daily">Daily (Günlük)</option>
                    <option value="per_ton">Per Ton (Ton Başına)</option>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-6 py-4 border border-gray-300 rounded-full focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors shadow-sm"
                    placeholder="Örn: XYZ Shipping Co."
                  />
                </div>
              </>
            )}
            ...
            {formData.serviceTransportMode === 'air' && (
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-6 py-4 border border-gray-300 rounded-full focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors shadow-sm"
                  placeholder="Örn: TK123 veya Boeing 747 Freighter"
                />
              </div>
            )}
            ...
            {formData.serviceTransportMode === 'rail' && (
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-6 py-4 border border-gray-300 rounded-full focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors shadow-sm"
                  placeholder="Örn: TR456 veya Halkalı-Kapıkule Hattı"
                />
              </div>
            )}
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={4}
              className="w-full px-6 py-4 border border-gray-300 rounded-3xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors shadow-sm"
              required
          ...
          {formData.serviceTransportMode && (
            <div className="bg-white/50 rounded-3xl p-6 border border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {(requiredDocuments[formData.serviceTransportMode as keyof typeof requiredDocuments] as string[]).map((document, index) => (
              ...
              {selectedDocuments.length > 0 && (
                <div className="mt-4 p-3 bg-purple-50 rounded-3xl border border-purple-200">
          ...
          <div className="flex justify-end gap-4 pt-8 border-t border-gray-200">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-8 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl hover:from-purple-700 hover:to-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center gap-2 font-medium transform hover:scale-105 shadow-lg"
